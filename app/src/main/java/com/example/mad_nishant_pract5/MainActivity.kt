...
import com.example.mad_nishant_pract5.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    val bPlay =
        findViewById<FloatingActionButton>(R.id.playButton) val
            bStop = findViewById<FloatingActionButton>(R.id.stopButton)
    bPlay.setOnClickListener{ play() }
    bStop.setOnClickListener{ stop()
    }
} fun
        play(){
